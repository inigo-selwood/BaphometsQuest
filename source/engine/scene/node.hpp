 ...
 * traversal, expose string-based XML properties, and provide typed local
 * signals.
 */
class Node {
  public:
    ...
    /**
     * Apply a string property from XML scene data.
     *
     * Derived nodes should handle supported names and call the base
     * implementation for unknown properties.
     */
    virtual void
